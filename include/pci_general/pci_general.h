...
class PCIGeneral : public PCIManager {
 ...
 private:
  visualization_msgs::MarkerArray::Ptr generateTrajectoryMarkerArray(const std::vector<geometry_msgs::Pose>& traj) const;
  ...
  bool actionDoneCallback(const actionlib::SimpleClientGoalState &state, 
                          const planner_msgs::pathFollowerActionResultConstPtr &result);
  void actionActiveCallback();
  void actionFeedbackCallback(const planner_msgs::pathFollowerActionFeedbackConstPtr &feedback);
